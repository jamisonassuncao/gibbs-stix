...
# model = Solution(name = 'Plagioclase', solution_model = SymmetricRegularSolution(endmembers= [[mineral_a,'[Na]AlSi3O8'], [mineral_b, '[Ca]Al2Si2CaO8']], energy_interaction=[[26.0e3]]))
...
# model = Solution(name= 'Clinopyroxene', solution_model = SymmetricRegularSolution(endmembers= [[mineral_a, '(Ca)(Mg)(Si2)O6'], [mineral_b, '(Ca)(Fe)(Si2)O6'], [mineral_c, '(Mg)(Mg)(Si2)O6'], [mineral_d, '(Ca)(Al)(Si Al)O6'], [mineral_e, '(Na)(Al)(Si2)O6']], energy_interaction=[[0.000e+00, 2.470e+04, 2.600e+04, 2.430e+04],[2.470e+04, 0.000e+00, 0.000e+00],[6.060e+04, 0.000e+00],[1.000e+04]]))
...
model = Solution(name = 'Quartz', solution_model = SymmetricRegularSolution(endmembers= [[mineral_a,fml(mineral_a)]], energy_interaction=[[0.0e3]]))
model.set_composition([1.0])
model.set_state(pressure, temperature)
mineral_a.set_state(pressure, temperature)
